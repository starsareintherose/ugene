...
const QString PCRPrimerDesignForDNAAssemblyOPWidgetFactory::GROUP_DOC_PAGE = "71958581";
...
QWidget* PCRPrimerDesignForDNAAssemblyOPWidgetFactory::createWidget(GObjectViewController* objView, const QVariantMap& ) {
